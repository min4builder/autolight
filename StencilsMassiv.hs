...
{-# INLINEABLE gradient' #-}
gradient' :: (Default a, Num a, Source r Ix1 a, Unbox a) => Matrix r Dim2 a -> Matrix MResult Dim2 (a, a)
...
{-# INLINEABLE gameOfLife' #-}
gameOfLife' :: Load r Ix1 Bool => Matrix r Dim2 Bool -> Matrix MResult Dim2 Bool
